...
<!--   <section class="section__container">
    ...
    <video loop autoplay class="fullscreen-bg__video_masks">
        <source src="vids/maskgallery.webm" type="video/webm">
        <source src="vids/maskgallery.mp4" type="video/mp4">
        <source src="vids/maskgallery.ogv" type="video/ogg">
    </video>
</div>
	    	</body>
	    </html>	
