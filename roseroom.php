...
<!--   <section class="section__container">
    ...
    <video loop autoplay class="fullscreen-bg__video_roseroom">
        <source src="vids/roseroom.webm" type="video/webm">
        <source src="vids/roseroom.mp4" type="video/mp4">
        <source src="vids/roseroom.ogv" type="video/ogg">
    </video>
</div>
	    	</body>
	    </html>	
